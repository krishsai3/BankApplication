...
public class TestApp {
	public static void main(String[] args) {
		...
		AccountHolder ah1 = new AccountHolder("sai","hyderabad","9090909090","sai@ineuron.in");
		Account ac1 = new Account("HDFC001",ah1,10000,"hdfcSai","1100");
		
		AccountHolder ah2 = new AccountHolder("vam","bangalore","9090909091","vam@ineuron.in");
		Account ac2 = new Account("HDFC002",ah2,20000,"hdfcVam","1101");
		
		AccountHolder ah3 = new AccountHolder("varma","kolkata","9090909092","varma@ineuron.in");
		Account ac3 = new Account("HDFC003",ah3,30000,"hdfcVarma","1102");
		
		AccountHolder ah4 = new AccountHolder("charan","chennai","9090909093","charan@ineuron.in");
